...
algorithmList <-c("MOEAD-Std", "MOEAD-StdArch", "MOEAD-RE3D", "MOEAD-RWA") 
tabularString <-c("lccc") 
latexTableFirstLine <-c("\\hline  & MOEAD-StdArch & MOEAD-RE3D & MOEAD-RWA\\\\ ") 
indicator<-"HV"

 # Step 1.  Writes the latex header
latexHeader()
tabularString <-c("| l | cccccccccccccccccccccccccc | cccccccccccccccccccccccccc | cccccccccccccccccccccccccc | ") 

latexTableFirstLine <-c("\\hline \\multicolumn{1}{|c|}{} & \\multicolumn{26}{c|}{MOEAD-StdArch} & \\multicolumn{26}{c|}{MOEAD-RE3D} & \\multicolumn{26}{c|}{MOEAD-RWA} \\\\") 
