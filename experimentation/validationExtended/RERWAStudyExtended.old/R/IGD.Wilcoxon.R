...
algorithmList <-c("NSGAII-Std", "MOEAD-Standard", "RVEA", "AGE-MOEA", "NSGAII-RE3D", "NSGAII-RWA3D") 
tabularString <-c("lccccc") 
latexTableFirstLine <-c("\\hline  & MOEAD-Standard & RVEA & AGE-MOEA & NSGAII-RE3D & NSGAII-RWA3D\\\\ ") 
indicator<-"IGD"

 # Step 1.  Writes the latex header
latexHeader()
tabularString <-c("| l | cccccccccccccccccccccccccc | cccccccccccccccccccccccccc | cccccccccccccccccccccccccc | cccccccccccccccccccccccccc | cccccccccccccccccccccccccc | ") 

latexTableFirstLine <-c("\\hline \\multicolumn{1}{|c|}{} & \\multicolumn{26}{c|}{MOEAD-Standard} & \\multicolumn{26}{c|}{RVEA} & \\multicolumn{26}{c|}{AGE-MOEA} & \\multicolumn{26}{c|}{NSGAII-RE3D} & \\multicolumn{26}{c|}{NSGAII-RWA3D} \\\\") 
