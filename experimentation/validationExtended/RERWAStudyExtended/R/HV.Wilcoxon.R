...
algorithmList <-c("NSGAII-Std", "MOEAD", "RVEA", "NSGAII-RE3D", "NSGAII-RWA3D") 
tabularString <-c("lcccc") 
latexTableFirstLine <-c("\\hline  & MOEAD & RVEA & NSGAII-RE3D & NSGAII-RWA3D\\\\ ") 
indicator<-"HV"
...
latexTableFirstLine <-c("\\hline \\multicolumn{1}{|c|}{} & \\multicolumn{26}{c|}{MOEAD} & \\multicolumn{26}{c|}{RVEA} & \\multicolumn{26}{c|}{NSGAII-RE3D} & \\multicolumn{26}{c|}{NSGAII-RWA3D} \\\\") 
