...
\title{Parameter Space for SMSEMOADoubleFull Algorithm}
...
\begin{table}[!tb]
\caption{Parameter space of SMSEMOADoubleFull.}
\label{tab:params_smsemoadoublefull}
\centering
\resizebox{\textwidth}{!}{%
\small
...
This parameter space contains 20 parameters total, of which 16 are conditional parameters that are only active under specific conditions.
