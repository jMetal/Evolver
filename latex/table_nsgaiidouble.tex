...
\title{Parameter Space for NSGAIIDouble Algorithm}
...
This parameter space contains 20 parameters total, of which 15 are conditional parameters that are only active under specific conditions.
