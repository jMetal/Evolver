...
algorithmList <-c("NSGAII-Standard", "Complete-RWA3D", "Complete-RWA3D-ArchiveReset", "Complete-RWA3D-CrossoverReset", "Complete-RWA3D-MutationReset") 
tabularString <-c("lcccc") 
latexTableFirstLine <-c("\\hline  & Complete-RWA3D & Complete-RWA3D-ArchiveReset & Complete-RWA3D-CrossoverReset & Complete-RWA3D-MutationReset\\\\ ") 
indicator<-"EP"
...
latexTableFirstLine <-c("\\hline \\multicolumn{1}{|c|}{} & \\multicolumn{10}{c|}{Complete-RWA3D} & \\multicolumn{10}{c|}{Complete-RWA3D-ArchiveReset} & \\multicolumn{10}{c|}{Complete-RWA3D-CrossoverReset} & \\multicolumn{10}{c|}{Complete-RWA3D-MutationReset} \\\\") 
...
for (i in algorithmList) {
  if (i != "Complete-RWA3D-MutationReset") {
    ...
    for (j in algorithmList) {
      for (problem in problemList) {
        if (jndx != 0) {
          ...
          if (problem == "RWA10") {
            if (j == "Complete-RWA3D-MutationReset") {
              write(" \\\\ ", "EP.Wilcoxon.tex", append=TRUE)
            } 
            else {
              write(" & ", "EP.Wilcoxon.tex", append=TRUE)
