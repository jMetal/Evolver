...
algorithmList <-c("NSGAII-Standard", "Extreme-RE3D", "Extreme-RE3D-ArchiveReset", "Extreme-RE3D-CrossoverReset", "Extreme-RE3D-MutationReset") 
tabularString <-c("lcccc") 
latexTableFirstLine <-c("\\hline  & Extreme-RE3D & Extreme-RE3D-ArchiveReset & Extreme-RE3D-CrossoverReset & Extreme-RE3D-MutationReset\\\\ ") 
indicator<-"EP"
...
latexTableFirstLine <-c("\\hline \\multicolumn{1}{|c|}{} & \\multicolumn{16}{c|}{Extreme-RE3D} & \\multicolumn{16}{c|}{Extreme-RE3D-ArchiveReset} & \\multicolumn{16}{c|}{Extreme-RE3D-CrossoverReset} & \\multicolumn{16}{c|}{Extreme-RE3D-MutationReset} \\\\") 
...
for (i in algorithmList) {
  if (i != "Extreme-RE3D-MutationReset") {
    ...
    for (j in algorithmList) {
      for (problem in problemList) {
        if (jndx != 0) {
          ...
          if (problem == "RE91") {
            if (j == "Extreme-RE3D-MutationReset") {
              write(" \\\\ ", "EP.Wilcoxon.tex", append=TRUE)
            } 
            else {
              write(" & ", "EP.Wilcoxon.tex", append=TRUE)
