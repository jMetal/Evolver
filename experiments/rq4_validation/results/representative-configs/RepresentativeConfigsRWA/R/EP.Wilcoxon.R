...
latexTableFirstLine <-c("\\hline \\multicolumn{1}{|c|}{} & \\multicolumn{10}{c|}{Complete-RE3D} & \\multicolumn{10}{c|}{Extreme-RE3D} & \\multicolumn{10}{c|}{Complete-RWA3D} & \\multicolumn{10}{c|}{Extreme-RWA3D} \\\\") 
