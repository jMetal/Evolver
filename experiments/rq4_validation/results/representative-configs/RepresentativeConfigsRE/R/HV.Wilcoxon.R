...
algorithmList <-c("NSGAII-Standard", "Complete-RE3D", "Extreme-RE3D", "Complete-RWA3D", "Extreme-RWA3D") 
tabularString <-c("lcccc") 
latexTableFirstLine <-c("\\hline  & Complete-RE3D & Extreme-RE3D & Complete-RWA3D & Extreme-RWA3D\\\\ ") 
indicator<-"HV"
...
latexTableFirstLine <-c("\\hline \\multicolumn{1}{|c|}{} & \\multicolumn{16}{c|}{Complete-RE3D} & \\multicolumn{16}{c|}{Extreme-RE3D} & \\multicolumn{16}{c|}{Complete-RWA3D} & \\multicolumn{16}{c|}{Extreme-RWA3D} \\\\") 
