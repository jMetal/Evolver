...
### START OF SCRIPT 
# Constants
problemList <-c("RE21", "RE22", "RE23", "RE24", "RE25", "RE31", "RE32", "RE33", "RE34", "RE35", "RE36", "RE37", "RE41", "RE42", "RE61", "RE91") 
algorithmList <-c("NSGAII-Standard", "Complete-RE3D", "Complete-RE3D-ArchiveReset", "Complete-RE3D-CrossoverReset", "Complete-RE3D-MutationReset") 
tabularString <-c("lcccc") 
latexTableFirstLine <-c("\\hline  & Complete-RE3D & Complete-RE3D-ArchiveReset & Complete-RE3D-CrossoverReset & Complete-RE3D-MutationReset\\\\ ") 
indicator<-"HV"
...
latexTableFirstLine <-c("\\hline \\multicolumn{1}{|c|}{} & \\multicolumn{16}{c|}{Complete-RE3D} & \\multicolumn{16}{c|}{Complete-RE3D-ArchiveReset} & \\multicolumn{16}{c|}{Complete-RE3D-CrossoverReset} & \\multicolumn{16}{c|}{Complete-RE3D-MutationReset} \\\\") 

# Step 3. Problem loop 
latexTableHeader("RE21 RE22 RE23 RE24 RE25 RE31 RE32 RE33 RE34 RE35 RE36 RE37 RE41 RE42 RE61 RE91 ", tabularString, latexTableFirstLine)

indx = 0
for (i in algorithmList) {
  if (i != "Complete-RE3D-MutationReset") {
    ...
    for (j in algorithmList) {
      for (problem in problemList) {
        if (jndx != 0) {
          ...
          if (problem == "RE91") {
            if (j == "Complete-RE3D-MutationReset") {
              write(" \\\\ ", "HV.Wilcoxon.tex", append=TRUE)
            } 
            else {
              write(" & ", "HV.Wilcoxon.tex", append=TRUE)
