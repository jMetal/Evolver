...
public interface ParameterProcessor {
   ...
   * @param parameterConfig Configuration map for the parameter, which must include at least 'type' and either 'values' or 'globalSubParameters'
   ...
   */
  void process(String parameterName, Object parameterConfig, ParameterSpace parameterSpace);
}
