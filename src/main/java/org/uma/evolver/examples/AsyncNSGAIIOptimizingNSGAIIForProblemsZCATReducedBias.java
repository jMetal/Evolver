 ...
 */
public class AsyncNSGAIIOptimizingNSGAIIForProblemsZCATReducedBias {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (args.length != 4) {
      ...
      trainingEvaluationsPercentage = Double.parseDouble(args[3]);
    }
    ...
    OutputResultsManagementParameters outputResultsManagementParameters =
            new OutputResultsManagementParameters(
                    ...
                    indicators,
                    outputDirectory + "/AsyncNSGAII/"+problemFamilyInfo.name()+ "/bias");
    ...
    RunTimeChartObserver<DoubleSolution> runTimeChartObserver =
            new RunTimeChartObserver<>(
                    "NSGA-II - ZCAT reduce", 80, 100, null, indicators.get(0).name(), indicators.get(1).name());
