...
/**
 * Represents the contribution of a single parameter change to the overall
 ...
 * @param contribution   the performance change when reverting to default
 *                       (positive means the optimized value is better)
...
public record ParameterContribution(
    ...
    /**
     * Returns the total absolute contribution across all indicators.
     */
