...
public class AblationResult {
    ...
    /**
     * Returns contributions sorted by total impact (descending).
     */
    ...
    /**
     * Calculates the total improvement from default to optimized.
     */
