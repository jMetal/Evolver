...
/**
 * Configuration class for ablation analysis experiments.
 * Provides a fluent API for configuring all aspects of an ablation analysis.
 * 
...
public class AblationConfiguration {
    ...
    public String getProblemSuite() { return problemSuite; }
    ...
    public String getYamlParameterSpaceFile() { return yamlParameterSpaceFile; }
    public String getDefaultConfigString() { return defaultConfigString; }
    public String getOptimizedConfigString() { return optimizedConfigString; }
    public List<QualityIndicator> getIndicators() { return indicators; }
    public boolean isProgressReportingEnabled() { return enableProgressReporting; }
    ...
    public boolean isValidateConfigurations() { return validateConfigurations; }
    ...
    public static AblationConfiguration forDTLZProblems() {
        return new AblationConfiguration()
            ...
            .optimizedConfiguration("--algorithmResult externalArchive --populationSizeWithArchive 117 --archiveType unboundedArchive --createInitialSolutions latinHypercubeSampling --offspringPopulationSize 10 --variation crossoverAndMutationVariation --crossover SBX --crossoverProbability 0.7508401473188827 --crossoverRepairStrategy random --sbxDistributionIndex 50.1629616234419 --mutation uniform --mutationProbabilityFactor 0.8987004036508917 --mutationRepairStrategy bounds --uniformMutationPerturbation 0.21357323319678467 --selection tournament --selectionTournamentSize 7");
    }
    
    @Override
    public String toString() {
        return String.format("AblationConfiguration{name='%s', suite='%s', runs=%d, evaluations=%d, threads=%d}", 
