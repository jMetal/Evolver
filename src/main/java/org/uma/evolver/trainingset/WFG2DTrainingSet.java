 ...
 *
 * <p>
 * The {@code 2D} suffix is included here to make explicit that this set targets
 * bi-objective
 * variants of the WFG family. If other dimensionalities are added in the
 * future, follow the same
...
public class WFG2DTrainingSet extends AbstractTrainingSet<DoubleSolution> {
  ...
  private static final List<String> REFERENCE_FRONT_FILE_NAMES = List.of(
      "WFG1.2D.csv",
      "WFG2.2D.csv",
      "WFG3.2D.csv",
      "WFG4.2D.csv",
