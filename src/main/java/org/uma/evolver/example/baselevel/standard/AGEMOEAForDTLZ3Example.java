...
/**
 * Evolver port of jmetal-component {@code AGEMOEADefaultConfigurationForDTLZ3Example}.
 *
 * <p>Runs AGE-MOEA (original variant) on DTLZ3 with the same operators and termination as the
 * jMetal reference example: SBX(p=0.9, di=20), Polynomial(p=1/n, di=20), pop=100, 40000 evals.
 */
