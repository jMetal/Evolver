 ...
 * analyzes which parameters have the most influence on the optimization
 * outcome.
 * 
...
public class FeatureImportanceExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path resultsDir = Path.of("RESULTS/MOPSO/DTLZ");
        ...
        for (String param : giniImp.keySet()) {
            if (count++ >= 10)
                break;
            System.out.printf("%2d. %-35s Gini: %.4f, Perm: %.4f%n",
