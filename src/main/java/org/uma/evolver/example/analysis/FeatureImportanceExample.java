...
/**
 * Example demonstrating feature importance analysis on meta-optimization results.
 *
 * <p>This example loads the output from a meta-optimization experiment and analyzes which
...
public class FeatureImportanceExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Path resultsDir = Path.of("RESULTS/NSGAII/WFG");

    // Create analyzer
    FeatureImportanceAnalyzer analyzer =
        new FeatureImportanceAnalyzer(resultsDir).setNumberOfTrees(100).setMaxDepth(10).setSeed(42);
