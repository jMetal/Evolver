...
/**
 * Runner to execute algorithm configuration validation experiments. Compares six algorithm
 * variants (NSGAII-Standard, MOEAD-Standard, NSGAII-RE3D, NSGAII-RE3D-Est, NSGAII-RWA3D,
 * NSGAII-RWA3D-Est) across RE and RWA benchmark problems. Generates FUN (Pareto Fronts) and VAR
 * (Decision Variables) files for analysis.
 *
 * <p>Configuration: PopSize 100, 10000 evaluations, 25 independent runs per configuration.
 */
public class RERWAStudy {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Experiment<DoubleSolution, List<DoubleSolution>> experiment =
        new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("RERWAStudy")
  ...
  static List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> configureAlgorithmList(
    ...
    // Standard NSGA-II configuration WITH external archive
    // Used as a fair baseline against meta-optimized configurations that also use archives.
    String standardNSGAIIArchiveConfig =
        String.join(
            " ",
    ...
    String bestRE3DConfig =
        String.join(
            ...
            "--selection boltzmann",
            "--boltzmannTemperature 86.5333639568");
