 ...
 *
 * <ul>
 *   <li>{@code java SimpleZDTAblationExample} - Run with default settings
 *   <li>{@code java SimpleZDTAblationExample --threads 4} - Use 4 threads
 *   <li>{@code java SimpleZDTAblationExample --sequential} - Force sequential execution
 *   <li>{@code java SimpleZDTAblationExample --no-progress} - Disable progress reporting
 *   <li>{@code java SimpleZDTAblationExample --runs 25} - Use 25 runs per configuration
 * </ul>
 *
