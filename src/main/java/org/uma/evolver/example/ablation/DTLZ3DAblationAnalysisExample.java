...
/**
 * Example demonstrating multi-problem ablation analysis for NSGA-II using a training set of DTLZ
 * problems.
 *
 * <p>This example evaluates parameter contributions across DTLZ1, DTLZ2, DTLZ3, DTLZ4, and DTLZ7 
 * using an optimized configuration obtained from AsyncNSGAIIOptimizingNSGAIIForBenchmarkDTLZ
 * with the lowest IGD+ value after 2000 evaluations.
 *
 * <p>The DTLZ problems are scalable test problems commonly used for many-objective optimization research.
 * DTLZ3 is particularly challenging due to its multimodal landscape.
 * 
 * <p>This version has been refactored to use the configuration-based approach with {@link AblationRunner}.
 * For a simpler version, see {@link SimpleDTLZAblationExample}.
 *
...
public class DTLZ3DAblationAnalysisExample {
  ...
  private static void printUsage() {
    System.out.println("Usage: java DTLZ3DAblationAnalysisExample [options]");
    System.out.println();
    ...
    System.out.println("  java DTLZ3DAblationAnalysisExample");
    System.out.println("  java DTLZ3DAblationAnalysisExample --threads 8 --runs 15");
    System.out.println("  java DTLZ3DAblationAnalysisExample --sequential --no-progress");
    System.out.println();
