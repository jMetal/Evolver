 ...
 */
public class DoubleRDEMOEAV2 extends BaseRDEMOEAV2<DoubleSolution> {
  /**
   ...
   */
  public DoubleRDEMOEAV2(int populationSize, ParameterSpace parameterSpace) {
  ...
  public BaseLevelAlgorithm<DoubleSolution> createInstance(
    ...
    return new DoubleRDEMOEAV2(problem, populationSize, maximumNumberOfEvaluations, parameterSpace.createInstance());
  }
