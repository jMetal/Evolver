 ...
 */
public class NSGAIIBinaryV2 extends AbstractNSGAIIV2<BinarySolution> {
  /**
   ...
   */
  public NSGAIIBinaryV2(int populationSize, ParameterSpace parameterSpace) {
  ...
  public BaseLevelAlgorithm<BinarySolution> createInstance(
    ...
    return new NSGAIIBinaryV2(problem, populationSize, maximumNumberOfEvaluations, parameterSpace.createInstance());
  }
