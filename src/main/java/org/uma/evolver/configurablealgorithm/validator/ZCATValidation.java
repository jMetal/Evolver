...
import org.uma.evolver.problemfamilyinfo.ZCATFullProblemFamilyInfo;

public class ZCATValidation {
  public static void main(String[] args) throws IOException {
    ...
    for (int i : IntStream.range(0, evaluations.size()).toArray()) {
      validator.validate(
          configurations.get(i).split("\\s+"),
          new ZCATFullProblemFamilyInfo(),
          "ZCATValidation" + evaluations.get(i) + ".csv");
    }
  }
}
