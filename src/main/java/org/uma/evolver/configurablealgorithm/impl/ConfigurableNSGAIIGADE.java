 ...
 */
public class ConfigurableNSGAIIGADE implements ConfigurableAlgorithmBuilder {
  ...
  public ConfigurableNSGAIIGADE() {
    this.configure() ;
  }

  public ConfigurableNSGAIIGADE(DoubleProblem problem, int populationSize,
  ...
  public ConfigurableAlgorithmBuilder createBuilderInstance() {
    return new ConfigurableNSGAIIGADE(problem, populationSize, maximumNumberOfEvaluations);
  }
