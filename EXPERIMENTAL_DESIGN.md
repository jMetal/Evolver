...
|---|---|---|
| `referenceFronts` | `results/2026.03.05.results` | Estimated Pareto fronts |
| `extremePointsFronts` | `results/2026.03.11.results` | Extreme-point-based fronts |
...
```
*(Example: `results/2026.03.05.results/RE3D.referenceFronts.1000/run1/VAR_CONF.txt`)*
