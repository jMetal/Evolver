...
The `full code of this example <https://github.com/jMetal/Evolver/blob/3aa70af1a3f874a28b9588c265a7a44c289d4303/src/main/java/org/uma/evolver/example/training/zdt/NSGAIIOptimizingNSGAIIForProblemZDT4MinimizingEvaluations.java>`_ is available in the project history; it is no longer part of the examples package, which was reduced to a minimal illustrative set.