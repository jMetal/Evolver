...
Evolver encodes metaheuristic configurations as real-valued vectors to enable efficient optimization. This section explains the encoding scheme and its implications.
